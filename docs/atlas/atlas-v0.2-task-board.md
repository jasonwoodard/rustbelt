...
| A2.4 | Update fixture regeneration scripts to incorporate anchors/sub-clusters for regression coverage. | PENDING | A2.3 | Regenerated fixtures stored; CI regression leverages new artifacts. |
